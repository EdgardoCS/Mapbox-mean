...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="FUNC">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="MON_HCO">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="PROPIEDAD">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="INAUG">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="175,161,90,255"/>
  ...
  <aliases>
    ...
    <alias field="FUNC" index="3" name=""/>
    <alias field="MON_HCO" index="4" name=""/>
    <alias field="PROPIEDAD" index="5" name=""/>
    <alias field="INAUG" index="6" name=""/>
    <alias field="OBS" index="7" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="737277816">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="FUNC"/>
      <column width="-1" hidden="0" type="field" name="MON_HCO"/>
      <column width="-1" hidden="0" type="field" name="PROPIEDAD"/>
      <column width="-1" hidden="0" type="field" name="INAUG"/>
      <column width="-1" hidden="0" type="field" name="OBS"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="FUNC" expression=""/>
    <default field="MON_HCO" expression=""/>
    <default field="PROPIEDAD" expression=""/>
    <default field="INAUG" expression=""/>
